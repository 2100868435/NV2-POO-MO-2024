...
def menu():
    ...
    while True:
        ...
        if opcion == '1':
            ...
            id = input("Ingrese el ID del producto:39123439 ")
            nombre = input("Ingrese el nombre del producto:aceite ")
            cantidad = int(input("Ingrese la cantidad del producto:1 "))
            precio = float(input("Ingrese el precio del producto:3,99 "))
            ...
            id = input("Ingrese el ID del producto a eliminar:39123439 ")
            inventario.eliminar_producto(id)  # Eliminar el producto por su ID

        elif opcion == '3':
            # Opción para actualizar un producto
            id = input("Ingrese el ID del producto a actualizar:48125433 ")
            ...
            nombre = input("Ingrese el nombre del producto a buscar:queso ")
            ...
            print("Saliendo del sistema de inventario.gracias por utilizar el sistema de inventario. hasta luego")
